			...
			<div className="box center--horizontal">
			 <table className="buttons-table">
				<tbody>
				 ...
				 <tr>
					<td>
					 {this.props.test.includes("fnb") && this.props.response_device === "keyboard" && <img src={keypic} alt="Keyboard" className="keyboard center--horizontal"/>}
					 {this.props.test.includes("fnb") && this.props.response_device !== "keyboard" &&
					 <div className="keyboard center--horizontal">
					 <div className="lnb-demo device-icons">
<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="demo-click--icons bi bi-mouse2-fill" viewBox="0 0 16 16">
...
<span className="lnb-demo mouse-or-hand"> or </span>
<svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" className="demo-click--icons bi bi-hand-index-thumb-fill" viewBox="0 0 16 16">
