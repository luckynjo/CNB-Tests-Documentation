...
export class ER40ChildTrials extends React.Component{
  ...
  render()
  {
    ...
    const buttons = this.props.buttons.map((item, index) => {
      return (<div className="button er40--response-button-reg" key={index + 155} onClick={(e) => this.onClick(e, index+1)}><img src={this.emoji_array[index]} height="80" width = "80"/></div>)
    })
