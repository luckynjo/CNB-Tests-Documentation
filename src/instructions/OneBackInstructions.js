...
export const OneBackInstructions = props => {
  ...
  return (
    ...
    <div className = "instructions text--left center">
      ...
      <tr className="demo--1back">
      <td><span> </span></td>
        <td>{test.includes("fnb") ? <img src={Vr} className="stimulus--small right" alt="Press"/> : <p className="lnb stimulus-text--medium text--center">M</p>} </td>
        <td><span> </span></td>
        <td>{test.includes("fnb") ? <img src={Vr} className="stimulus--small left" alt="Press"/> : <p className="lnb stimulus-text--medium text--center">M</p>} </td>
        <td><span> </span></td>
      </tr>
      <tr>
      <td colSpan={5}><br/></td>
      ...
      {!test.includes("lnb") && <p className="instructions-text--small">{instructions[4] || ''}</p>}
    </div>
