...
export const GNGInstructions = props => {
  console.log("In GNGInstructions");
        ...
        if(instruction !== continue_button_text && instruction !== back_button_text)
        {
          ...
          else
          {
            if(index == 0){
              ...
              inst_str_buff1 = instruction;
            } else if(index == 2){
              inst_str_buff1 = inst_str_buff1 + " " + instruction + " ";
            } else if(index == 3){
              inst_str_buff2 = " " + instruction;
            } else if(index == 4){
              inst_str_buff3 = instruction;
            } else if(index == 5){
              inst_str_buff3 = inst_str_buff3 + " " + instruction + " ";
            } else if(index == 6){
              inst_str_buff4 = " " + instruction;
            } else if(index == 7){
              return (<div key={index*10 + 5}>
                <p>{inst_str_buff1}<img src={tap_icon}/>{inst_str_buff2}<img src={click_icon}/>{inst_str_buff3}<img src={tap_icon}/>{inst_str_buff4}<img src={click_icon}/>{instruction}</p>
                <br/>
              </div>)
            }
          }
