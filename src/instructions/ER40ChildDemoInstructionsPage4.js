...
*/
export default class ER40ChildDemoInstructionsPage4 extends React.Component
{
  constructor(props)
  {
    super(props);
    ...
    return (
      <div className="container-er40Slideshow">
        <table className="er40--table-2">
          ...
          <tr>
          <td colSpan={2}>
          <p style={{paddingTop: "10px"}} className={"er40--feedback-2"} >{this.props.instructions[0]}</p>
          </td>
          </tr>
            <tr>
              <td>
              ...
              <img src={cursor_1} height="80" width="80" style={{position: "relative", left: "90px", bottom: "80px", backgroundColor: "transparent"}}/>
              </td>
            </tr>
          </tbody>
        </table>
